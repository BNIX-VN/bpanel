...
export const vi = {
  ...
  "A chat ID is a number (negative for a group) or a @channel name": "Chat ID là một số (số âm nếu là group) hoặc tên kênh dạng @kenh",
  "A new password needs the current one, and the authenticator code when two-factor sign-in is on.": "Đổi mật khẩu cần nhập mật khẩu hiện tại, và mã xác thực nếu đang bật đăng nhập hai lớp.",
  ...
  "Add SecRuleRemoveById <id> to the custom rules below to excuse this site from one rule.": "Thêm SecRuleRemoveById <id> vào rule tùy chỉnh bên dưới để bỏ qua một rule cho website này.",
  ...
  "Country": "Quốc gia",
  "Create": "Tạo",
  "Create a bot with @BotFather (/newbot) and paste its token. Then send the bot any message - or add it to a group - press Find chat ID and pick the chat.": "Tạo bot bằng @BotFather (/newbot) rồi dán token. Sau đó nhắn cho bot một tin bất kỳ - hoặc thêm bot vào group - bấm Tìm Chat ID và chọn chat.",
  ...
  "Download": "Tải về",
  "Download SQL dump": "Tải bản SQL dump",
  ...
  "Email goes through the SMTP server you set; Telegram through a bot you create with @BotFather. Each administrator picks their channels and mutes what they do not want.": "Email gửi qua máy chủ SMTP bạn cấu hình; Telegram qua bot bạn tạo bằng @BotFather. Mỗi quản trị viên tự chọn kênh và tắt những thông báo không muốn nhận.",
  "Email is not set up on this server yet.": "Server chưa cấu hình gửi email.",
  "Email is required.": "Cần nhập email.",
  "Email needs an SMTP account (host, port, sender address). Mail sent straight from the server usually lands in spam.": "Email cần một tài khoản SMTP (máy chủ, cổng, địa chỉ gửi). Thư gửi thẳng từ server thường rơi vào spam.",
  ...
  "Flood on": "Flood bật",
  "Folder": "Thư mục",
  "For administrators only: customers do not see it and are not sent anything.": "Chỉ dành cho quản trị viên: khách hàng không thấy tính năng này và không nhận thông báo nào.",
  ...
  "Global WAF rules saved. They apply to every website with the WAF on.": "Đã lưu rule WAF toàn cục. Rule áp dụng cho mọi website đang bật WAF.",
  ...
  "Inspects each request for SQL injection, XSS and similar attacks.": "Kiểm tra từng request để chặn SQL injection, XSS và các kiểu tấn công tương tự.",
  "Inspects each request for SQL injection, XSS and similar attacks. Each website turns it on from its own page.": "Kiểm tra từng request để chặn SQL injection, XSS và các kiểu tấn công tương tự. Mỗi website tự bật trong trang cấu hình của nó.",
  "Inspects each request for SQL injection, XSS and similar attacks. Uses about {n} MB of server RAM.": "Kiểm tra từng request để chặn SQL injection, XSS và các kiểu tấn công tương tự. Tốn khoảng {n} MB RAM của server.",
  "Install": "Cài đặt",
  ...
  "Installed": "Đã cài",
  "Installed from the system packages; PHP-FPM reloads so websites can use it straight away. Removing is not offered here, since a website may depend on it.": "Cài từ gói của hệ điều hành; PHP-FPM tự nạp lại để website dùng được ngay. Không có nút gỡ, vì có thể có website đang cần extension đó.",
  ...
  "ModSecurity rules for every website with the WAF on. Rules an AI assistant added are marked # bpanel-mcp; delete a rule by deleting its lines.": "Rule ModSecurity áp dụng cho mọi website đang bật WAF. Rule do trợ lý AI thêm có dòng # bpanel-mcp; muốn xoá rule nào thì xoá các dòng của rule đó.",
  "Mode": "Chế độ",
  ...
  "No messages yet. Send the bot a message first, then press Find chat ID again.": "Bot chưa nhận tin nhắn nào. Hãy nhắn cho bot trước, rồi bấm Tìm Chat ID lại.",
  ...
  "Once when usage passes the threshold, again only after it has dropped back.": "Báo một lần khi vượt ngưỡng, chỉ báo lại sau khi đã giảm xuống.",
  ...
  "Only PHP scripts inside public_html and the safe WP-CLI commands are allowed.": "Chỉ cho phép script PHP trong public_html và các lệnh WP-CLI an toàn.",
  "Open": "Mở",
  ...
  "Optional features": "Tính năng tuỳ chọn",
  ...
  "Protection for each website. Open one to set its rules, flood limit and blocked bots.": "Bảo vệ từng website. Mở một website để đặt rule, giới hạn flood và bot bị chặn.",
  "Protection for your websites. Open one to set its rules and blocked bots.": "Bảo vệ các website của bạn. Mở một website để đặt rule và bot bị chặn.",
  "Protocol": "Giao thức",
  ...
  "Server events go to this chat once. An administrator with no chat of their own hears about their account here too.": "Các sự kiện của server được gửi vào chat này một lần. Quản trị viên chưa có chat riêng cũng nhận tin về tài khoản của mình tại đây.",
  ...
  "Tells administrators what needs their attention on the server, by email and Telegram.": "Báo cho quản trị viên những việc cần lưu ý trên server, qua email và Telegram.",
  ...
  "The bot has not received your /start message yet. Send it, then press Check again.": "Bot chưa nhận được tin nhắn /start của bạn. Hãy gửi rồi bấm Kiểm tra lại.",
  ...
  "The name suffix decides how many copies are kept: nothing keeps one per account, day of week keeps seven, week of month five, and full date one a day until retention removes it.": "Phần thêm vào tên quyết định số bản được giữ: không thêm giữ 1 bản mỗi tài khoản, thứ trong tuần giữ 7, tuần trong tháng giữ 5, ngày đầy đủ giữ mỗi ngày một bản cho tới khi bị dọn theo hạn lưu.",
  ...
  "The server: a service that stopped, a disk filling up, the firewall off, a failed backup, malware, certificates about to expire, a panel update.": "Về server: dịch vụ bị dừng, ổ đĩa sắp đầy, tường lửa tắt, backup lỗi, mã độc, chứng chỉ sắp hết hạn, có bản cập nhật panel.",
  ...
  "Turning the addon off stops every message and keeps the settings, each administrator's choices and the delivery log.": "Tắt addon sẽ dừng mọi thông báo nhưng giữ nguyên cấu hình, lựa chọn của từng quản trị viên và lịch sử gửi.",
  ...
  "Websites": "Website",
  "Websites with CRS on will start refusing requests that score above the threshold. Run Detect only first and read the logs, or a request somebody depends on may be the one it stops.": "Các website đã bật CRS sẽ bắt đầu từ chối request vượt ngưỡng điểm. Hãy chạy Chỉ phát hiện trước và đọc log, nếu không một request hợp lệ nào đó có thể bị chặn.",
  ...
  "You hear in the admin chat ({chat}). Connect a chat of your own to hear there instead.": "Bạn đang nhận tin ở chat quản trị ({chat}). Kết nối chat riêng nếu muốn nhận ở đó.",
  ...
  "Your own account: a sign-in from a new place, a password or two-factor change.": "Về tài khoản của bạn: đăng nhập từ nơi mới, đổi mật khẩu hoặc đăng nhập hai lớp.",
  ...
  "measuring...": "đang đo...",
  "nginx, PHP-FPM, MariaDB, Redis or the panel itself, checked every 5 minutes.": "nginx, PHP-FPM, MariaDB, Redis hoặc chính panel, kiểm tra mỗi 5 phút.",
  ...
  "{count} databases": "{count} database",
  ...
  "{secured} of {total} secured": "{secured}/{total} có SSL",
  "{used} of {limit}": "{used} trên {limit}",
