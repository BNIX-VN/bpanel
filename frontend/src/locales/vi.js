...
export const vi = {
  ...
  "Administrators hear about the server: a service that stopped, a disk filling up, the firewall off, a failed backup, malware, certificates about to expire, a panel update.": "Quản trị viên nhận tin về server: dịch vụ bị dừng, ổ đĩa sắp đầy, tường lửa tắt, backup lỗi, mã độc, chứng chỉ sắp hết hạn, có bản cập nhật panel.",
  ...
  "Email goes through the SMTP server you set; Telegram through a bot you create with @BotFather. Each person picks their channels and mutes what they do not want.": "Email gửi qua máy chủ SMTP bạn cấu hình; Telegram qua bot bạn tạo bằng @BotFather. Mỗi người tự chọn kênh và tắt những thông báo không muốn nhận.",
  ...
  "Every account hears about itself: a sign-in from a new place, a password or two-factor change, a suspension, and its own backups, malware, certificates and storage.": "Mỗi tài khoản nhận tin về chính mình: đăng nhập từ nơi mới, đổi mật khẩu hoặc đăng nhập hai lớp, bị tạm khoá, cùng backup, mã độc, chứng chỉ và dung lượng của mình.",
  ...
  "Tells administrators and customers what needs their attention, by email and Telegram.": "Báo cho quản trị viên và khách hàng những việc cần lưu ý, qua email và Telegram.",
  ...
  "Turning the addon off stops every message and keeps the settings, each person's choices and the delivery log.": "Tắt addon sẽ dừng mọi thông báo nhưng giữ nguyên cấu hình, lựa chọn của từng người và lịch sử gửi.",
