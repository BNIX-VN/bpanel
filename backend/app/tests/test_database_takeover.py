...
def test_accounts_with_a_dot_never_get_that_far():
    ...
    in a BPanel database user name. Asserted separately so the reserved-list
...
def test_an_account_that_already_exists_is_refused(monkeypatch):
    """Not just the reserved names: any account BPanel did not create.
    ...
    for accounts missing from BPanel's own table.
    """
