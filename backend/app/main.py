...
from app.api import addons as addons_api, auth, databases, fail2ban as fail2ban_api, firewall, maintenance, malware, packages, panel_settings as panel_settings_api, provisioning, services, sftp_accounts as sftp_accounts_api, site_apps as site_apps_api, terminal, updates, users, waf, websites
...
app.include_router(sftp_accounts_api.router, prefix="/api")
app.include_router(firewall.router, prefix="/api")
app.include_router(fail2ban_api.router, prefix="/api")
