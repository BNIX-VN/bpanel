...
time of this README, that tag is `v1.0.39`. To pin another release, run the
same command with `BPANEL_VERSION=v1.0.39` exported or set before the detection
